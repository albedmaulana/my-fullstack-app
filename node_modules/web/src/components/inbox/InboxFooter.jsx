...
const InboxFooter = () => {
  return (
    ...
    <footer className="w-full py-12 px-12 border-t border-slate-100 dark:border-slate-800 bg-white/30 grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div className="flex flex-col gap-3">
        ...
        <a className="text-slate-500 hover:text-[#2D7A4F] transition-colors text-sm" href="#">
